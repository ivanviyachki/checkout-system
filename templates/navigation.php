...
<div class="navigation">
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 25px 15%;">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <a class="nav-link" href="<?php echo home_url( '/checkout' ) ?>"><?php _e( 'Checkout', 'checkout-system' ) ?></a>
            </li>
            <li class="nav-item active">
            <a class="nav-link" href="<?php echo home_url( '/products' ) ?>"><?php _e( 'Products', 'checkout-system' ) ?></a>
            </li>
        </ul>
